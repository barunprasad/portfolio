...
// imagery), a 3D cursor tilt, glass surface and an accent glow on hover.
        ...
        <li key={project.title} data-animate>
          <TiltCard>
            <a
              ...
              className="group flex h-full flex-col overflow-hidden rounded-xl border border-line bg-surface/40 backdrop-blur-sm transition-[border-color,box-shadow] duration-300 hover:border-accent/40 hover:shadow-[0_10px_50px_-16px_rgba(200,255,0,0.25)]"
            >
